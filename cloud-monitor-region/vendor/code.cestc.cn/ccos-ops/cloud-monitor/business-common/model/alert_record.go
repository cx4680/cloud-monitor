...
import "code.cestc.cn/ccos-ops/cloud-monitor/business-common/global"
...
type AlertRecord struct {
	...
	CreateTime   global.JsonTime `orm:"create_time" json:"create_time"`
	UpdateTime   global.JsonTime `orm:"update_time" json:"update_time"`
}
