...
func contactGroupOpenApiV1Routers(group *gin.RouterGroup) {
	...
	group.GET("groups/:GroupId/contacts", logs.GinTrailzap(false, Read, logs.INFO, logs.AlertContactGroup), iam.AuthIdentify(&models.Identity{Product: iam.ProductMonitor, Action: "GetAlertContactList", ResourceType: "*", ResourceId: "*"}), contactGroupCtl.SelectContactPageByGroupId)
