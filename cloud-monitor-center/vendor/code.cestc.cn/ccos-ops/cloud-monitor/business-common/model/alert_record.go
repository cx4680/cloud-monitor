...
type AlertRecord struct {
	...
	RequestId      string    `gorm:"request_id;size=50" json:"request_id"`
	...
	RuleSourceType uint8     `gorm:"rule_source_type;default:1;force" json:"rule_source_type"`
	RuleSourceId   string    `gorm:"rule_source_id" json:"rule_source_id"`
	...
	Summary        string    `gorm:"summary;size=500" json:"summary"`
	...
	ContactInfo    string    `gorm:"contact_info;type:text" json:"contact_info"`   // 联系方式
