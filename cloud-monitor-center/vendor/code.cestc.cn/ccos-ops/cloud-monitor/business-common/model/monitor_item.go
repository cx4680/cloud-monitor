...
type MonitorItem struct {
	...
	Labels         string    `gorm:"column:labels" json:"-"`                                            // 标签名 分号隔开
	MetricsLinux   string    `gorm:"column:metrics_linux" json:"-"`                                     // linux表达式
	MetricsWindows string    `gorm:"column:metrics_windows" json:"-"`                                   // windows表达式
	...
	IsDisplay      uint8     `gorm:"column:is_display" json:"-"`                                        // 是否显示 0:不显示 1:显示
	...
	ShowExpression string    `gorm:"column:show_expression;autoCreateTime" json:"-"`                    // 展示表达式
}
