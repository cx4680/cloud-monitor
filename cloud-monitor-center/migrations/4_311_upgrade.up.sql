...
INSERT INTO t_monitor_product (biz_id, name, status, description, create_user, create_time, route, cron, host, page_url, abbreviation, sort, monitor_type) VALUES ('7', '传统裸金属', '1', 'bms', null, null, '/productmonitoring/bms', '0 0 0/1 * * ?', 'http://bms-manage-bms-union.product-bms-union:8082', '/compute/bms/ops/v1/tenants/{tenantId}/servers', 'bms', '11', '云产品监控');
