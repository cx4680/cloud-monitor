...
INSERT INTO t_monitor_item (biz_id, product_biz_id, name, metric_name, labels, metrics_linux, metrics_windows, statistics, unit, frequency, type, is_display, status, description, create_user, create_time, show_expression, display) VALUES ('206', '14', '接口响应延时', 'guard_http_latency_bucket_api', 'instance,route', 'histogram_quantile(0.90, sum by(instance,service,route,le)(rate(guard_http_latency_bucket{type="request",$INSTANCE}[3m])))', null, null, 'ms', null, null, '1', '1', null, null, null, null, 'chart');
...
INSERT INTO t_monitor_item (biz_id, product_biz_id, name, metric_name, labels, metrics_linux, metrics_windows, statistics, unit, frequency, type, is_display, status, description, create_user, create_time, show_expression, display) VALUES ('208', '14', '接口成功率', 'guard_nginx_url_request_succ_api', 'instance,route', 'sum by(instance,service,route)(rate(guard_nginx_url_request_succ{$INSTANCE}[3m]))', null, null, '%', null, null, '1', '1', null, null, null, null, 'chart,rule');
