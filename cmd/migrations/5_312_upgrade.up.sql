...
INSERT INTO t_monitor_item (biz_id, product_biz_id, name, metric_name, labels, metrics_linux, metrics_windows, statistics, unit, frequency, type, is_display, status, description, create_user, create_time, show_expression, display) VALUES ('205', '14', 'QPS', 'guard_nginx_http_current_reqs', 'instance,router', 'sum by(instance,service,router)(rate(guard_nginx_http_current_reqs{$INSTANCE}[3m]))', null, null, '次/s', null, null, '1', '1', null, null, null, null, 'chart');
INSERT INTO t_monitor_item (biz_id, product_biz_id, name, metric_name, labels, metrics_linux, metrics_windows, statistics, unit, frequency, type, is_display, status, description, create_user, create_time, show_expression, display) VALUES ('206', '14', '接口响应延时', 'guard_http_latency_bucket_api', 'instance,router', 'histogram_quantile(0.90, sum by(instance,service,router)(rate(guard_http_latency_bucket{type="request",$INSTANCE}[3m])) by (le))', null, null, 'ms', null, null, '1', '1', null, null, null, null, 'chart');
INSERT INTO t_monitor_item (biz_id, product_biz_id, name, metric_name, labels, metrics_linux, metrics_windows, statistics, unit, frequency, type, is_display, status, description, create_user, create_time, show_expression, display) VALUES ('207', '14', '服务响应延时', 'guard_http_latency_bucket_service', 'instance,service', 'histogram_quantile(0.90, sum by(instance,service)(rate(guard_http_latency_bucket{type="request",$INSTANCE}[3m])) by (le))', null, null, 'ms', null, null, '1', '1', null, null, null, null, 'chart');
INSERT INTO t_monitor_item (biz_id, product_biz_id, name, metric_name, labels, metrics_linux, metrics_windows, statistics, unit, frequency, type, is_display, status, description, create_user, create_time, show_expression, display) VALUES ('208', '14', '接口成功率', 'guard_nginx_url_request_succ_api', 'instance,router', 'sum by(instance,service,router)(rate(guard_nginx_url_request_succ{$INSTANCE}[3m]))', null, null, '%', null, null, '1', '1', null, null, null, null, 'chart,rule');
INSERT INTO t_monitor_item (biz_id, product_biz_id, name, metric_name, labels, metrics_linux, metrics_windows, statistics, unit, frequency, type, is_display, status, description, create_user, create_time, show_expression, display) VALUES ('209', '14', '服务成功率', 'guard_nginx_url_request_succ_service', 'instance,service', 'sum by(instance,service)(rate(guard_nginx_url_request_succ{$INSTANCE}[3m]))', null, null, '%', null, null, '1', '1', null, null, null, null, 'chart,rule');
INSERT INTO t_monitor_item (biz_id, product_biz_id, name, metric_name, labels, metrics_linux, metrics_windows, statistics, unit, frequency, type, is_display, status, description, create_user, create_time, show_expression, display) VALUES ('210', '14', '接口入口带宽监控', 'guard_bandwidth_api_ingress', 'instance,router', 'sum by(instance,service,router)(rate(guard_bandwidth{type="ingress",$INSTANCE}[3m]))', null, null, 'Byte/s', null, null, '1', '1', null, null, null, null, 'chart');
INSERT INTO t_monitor_item (biz_id, product_biz_id, name, metric_name, labels, metrics_linux, metrics_windows, statistics, unit, frequency, type, is_display, status, description, create_user, create_time, show_expression, display) VALUES ('211', '14', '接口出口带宽监控', 'guard_bandwidth_api_egress', 'instance,router', 'sum by(instance,service,router)(rate(guard_bandwidth{type="egress",$INSTANCE}[3m]))', null, null, 'Byte/s', null, null, '1', '1', null, null, null, null, 'chart');
INSERT INTO t_monitor_item (biz_id, product_biz_id, name, metric_name, labels, metrics_linux, metrics_windows, statistics, unit, frequency, type, is_display, status, description, create_user, create_time, show_expression, display) VALUES ('212', '14', '服务入口带宽监控', 'guard_bandwidth_service_ingress', 'instance,service', 'sum by(instance,service)(irate(guard_bandwidth{type="ingress",$INSTANCE}[3m])) ', null, null, 'Byte/s', null, null, '1', '1', null, null, null, null, 'chart');
INSERT INTO t_monitor_item (biz_id, product_biz_id, name, metric_name, labels, metrics_linux, metrics_windows, statistics, unit, frequency, type, is_display, status, description, create_user, create_time, show_expression, display) VALUES ('213', '14', '服务出口带宽监控', 'guard_bandwidth_service_egress', 'instance,service', 'sum by(instance,service)(rate(guard_bandwidth{type="egress",$INSTANCE}[3m]))', null, null, 'Byte/s', null, null, '1', '1', null, null, null, null, 'chart');
