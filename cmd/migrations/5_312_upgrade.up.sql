...
INSERT INTO t_monitor_item (biz_id, product_biz_id, name, metric_name, labels, metrics_linux, metrics_windows, statistics, unit, frequency, type, is_display, status, description, create_user, create_time, show_expression, display) VALUES ('219', '14', '服务调用量', 'guard_http_servicerequests', 'instance,service', 'guard_http_servicerequests{$INSTANCE}', null, null, '次', null, null, '1', '1', null, null, null, null, 'chart');
