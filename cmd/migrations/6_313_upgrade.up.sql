...
INSERT INTO `t_monitor_item` (biz_id, product_biz_id, name, metric_name, labels, metrics_linux, metrics_windows, statistics, unit, frequency, type, is_display, status, description, create_user, create_time, show_expression, display) VALUES ('224', '1', '上行流量', 'tenant_network_receive_rate_sum', '', 'sum(irate(ecs_network_receive_bytes_total{$INSTANCE}[3m])) / 1024 / 1024 * 8', NULL, NULL, 'Mbps', NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_monitor_item` (biz_id, product_biz_id, name, metric_name, labels, metrics_linux, metrics_windows, statistics, unit, frequency, type, is_display, status, description, create_user, create_time, show_expression, display) VALUES ('225', '1', '下行流量', 'tenant_network_transmit_rate_sum', '', 'sum(irate(ecs_network_transmit_bytes_total{$INSTANCE}[3m])) / 1024 / 1024 * 8', NULL, NULL, 'Mbps', NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL);
