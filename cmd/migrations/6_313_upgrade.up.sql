...
INSERT INTO t_monitor_item (biz_id, product_biz_id, name, metric_name, labels, metrics_linux, metrics_windows, statistics, unit, frequency, type, is_display, status, description, create_user, create_time, show_expression, display) VALUES ('226', '7', '物理机能耗', 'bms_total_power', 'instance', 'sum by(instance)(ipmi_sensor{name="total_power",$INSTANCE})', null, null, 'W', null, '2', '1', '1', null, null, null, null, 'chart');
INSERT INTO t_monitor_item (biz_id, product_biz_id, name, metric_name, labels, metrics_linux, metrics_windows, statistics, unit, frequency, type, is_display, status, description, create_user, create_time, show_expression, display) VALUES ('227', '7', '物理机CPU能耗', 'bms_cpu_power', 'instance', 'sum by(instance)(ipmi_sensor{name="cpu_power",$INSTANCE})', null, null, 'W', null, '2', '1', '1', null, null, null, null, 'chart');
INSERT INTO t_monitor_item (biz_id, product_biz_id, name, metric_name, labels, metrics_linux, metrics_windows, statistics, unit, frequency, type, is_display, status, description, create_user, create_time, show_expression, display) VALUES ('228', '7', '物理机MEM能耗', 'bms_memory_power', 'instance', 'sum by(instance)(ipmi_sensor{name="mem_power",$INSTANCE})', null, null, 'W', null, '2', '1', '1', null, null, null, null, 'chart');
